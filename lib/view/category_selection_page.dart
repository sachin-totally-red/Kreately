                    ...
                    builder: (context, AsyncSnapshot<List<Category>> snapshot) {
                      if (snapshot.hasData) {
                        return Align(
                          ...
                          child: ButtonTheme(
                            minWidth: ScreenUtil()
                                .setSp(295, allowFontScalingSelf: true),
                            height: ScreenUtil()
                            ...
                            child: RaisedButton(
                              ...
                              color: (selectedCategoryList.length > 0)
                                  ? Color(0xFFB44650)
                                  : Colors.grey.withOpacity(0.6),
                              shape: RoundedRectangleBorder(
...
class KaavyaCategoryCard extends StatefulWidget {
  final Category category;
  final CategorySelectionPageState categorySelectionPageState;

  KaavyaCategoryCard({this.category, this.categorySelectionPageState});

  @override
  _KaavyaCategoryCardState createState() => _KaavyaCategoryCardState();
}

class _KaavyaCategoryCardState extends State<KaavyaCategoryCard> {
  Color backgroundColor = Color(0xFFFFFFFF);
  Color titleColor = Color(0xFF111111);
  Color descColor = Color(0xFF707070);
    ...
    return GestureDetector(
      onTap: () {
        if (widget.category.alreadySelected) {
          ...
          selectedCategoryList.add(widget.category);
          setState(() {
            backgroundColor = Color(0xFFB44650);
            titleColor = Color(0xFFF8F8F8);
            descColor = Color(0xFFF8F8F8);
            widget.category.alreadySelected = true;
          });
        ...
        children: [
          Padding(
            ...
            child: Card(
              ...
              child: Container(
                constraints: BoxConstraints(
                  minHeight: ScreenUtil().setSp(40, allowFontScalingSelf: true),
                  minWidth: ScreenUtil().setSp(130, allowFontScalingSelf: true),
                ),
                // margin:
                // EdgeInsets.only(top: 12, left: 16, bottom: 12, right: 13),
                child: Column(
