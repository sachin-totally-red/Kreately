                ...
                return <Widget>[
                  SliverAppBar(
                    ...
                    backgroundColor: Color(int.parse(AppVariants
                        .completeMap[Constants.appName]["appBarColor"])),
                    ...
                    actions: <Widget>[
                      IconButton(
                        icon: ImageIcon(
                          AssetImage(AppVariants.completeMap[Constants.appName]
                              ["searchIcon"]),
                          color: Color(int.parse(
                              AppVariants.completeMap[Constants.appName]
                                  ["menuAndSearchIconColor"])),
                          size: ScreenUtil()
  ...
  if (Constants.appName == "Kaavya") {
    return ClipRRect(
      ...
      child: Container(
        ...
        child: Image.asset(
          'assets/images/kaavya/news_finish_image.png',
        ),
      ),
    );
  } else {
