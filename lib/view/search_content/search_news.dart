                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: (Constants.appName == "Kaavya")
                  ...
                  child: StreamBuilder(
                    ...
                    builder: (context, AsyncSnapshot<List<Post>> snapshot) {
                      if (textFormFieldController.text.length < 3)
                        return Container(
                          child: (Constants.appName == 'Nibbin')
                              ? predefinedSuggestions()
                              : ((Constants.appName == 'Kaavya')
                                  ? predefinedSuggestionsForKaavya()
                                  : Padding(
                      ...
                      if (!showSearchLoader) {
                        if (snapshot.hasData) {
                          if (snapshot.data.length > 0) {
                            ...
                            return (Constants.appName == 'Kaavya')
                                ? Padding(
                                    padding: EdgeInsets.only(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Image.asset(
                                              "assets/images/kaavya/no_search_result.png",
                                              height: MediaQuery.of(context)
                                                      .size
                                                      .height *
                                                  109 /
                                        ...
                                        ButtonTheme(
                                          minWidth: ScreenUtil().setSp(295,
                                              allowFontScalingSelf: true),
                                          height: ScreenUtil().setSp(55,
                                              allowFontScalingSelf: true),
                                          buttonColor: Color(0xFFB44650),
                                          child: RaisedButton(
                                            child: Text(
                                              "Back",
                                              style: TextStyle(
      ...
      child: Container(
        ...
        child: Wrap(
          ...
          children: [
            ...
            suggestionItem("Rudyard Kipling"),
            suggestionItem("It was the first night of spring"),
            suggestionItem("Kailash Manhar"),
            suggestionItem("Dr. Pariksith Singh"),
            suggestionItem("Razi Hashmy"),
          ],
        ),
      ),
    );
